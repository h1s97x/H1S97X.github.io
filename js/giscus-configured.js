...
// Giscus配置 - 请根据你的GitHub仓库信息修改
const giscusConfig = {
    repo: 'your-username/your-repo', // 替换为你的GitHub用户名/仓库名
    repoId: 'R_kgDOxxxxxx', // 替换为你的仓库ID（从giscus.app获取）
    category: 'Announcements', // 讨论分类
    categoryId: 'DIC_kwDOxxxxxx', // 替换为你的分类ID（从giscus.app获取）
