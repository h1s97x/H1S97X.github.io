...
### linux 下普通用户变为 root 权限的三种方法

[Linux 下普通用户变为 root 权限的三种方法\_19.如何从普通用户 xiaoming 切换到 root?-CSDN 博客](https://blog.csdn.net/weixin_43886632/article/details/108244302)

**方法 3**

修改 /etc/passwd 文件，找到 xiaoming，把用户 ID 修改为 0
