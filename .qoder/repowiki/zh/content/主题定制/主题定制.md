...
如果你需要配置 Stellar 主题，请查看以下详细的配置文档：

- [Stellar 配置指南](./Stellar配置指南.md) - 配置总览和快速开始
- [侧边栏配置](./配置管理/侧边栏配置.md) - Logo 和主导航菜单
- [站点结构配置](./配置管理/站点结构配置.md) - 页面布局和侧边栏组件
- [笔记本配置](./配置管理/笔记本配置.md) - 笔记本和笔记页面
- [文章配置](./配置管理/文章配置.md) - 文章类型、封面、摘要等
- [搜索配置](./配置管理/搜索配置.md) - 本地搜索和 Algolia
- [评论系统配置](./配置管理/评论系统配置.md) - Giscus、Twikoo、Waline 等
- [样式配置](./配置管理/样式配置.md) - 主题色、字体、圆角等
- [插件配置](./配置管理/插件配置.md) - Fancybox、Katex、Mermaid 等
- [数据服务配置](./配置管理/数据服务配置.md) - 内置服务和 API
- [页脚配置](./配置管理/页脚配置.md) - 社交链接、站点地图
- [标签插件配置](./配置管理/标签插件配置.md) - Note、Image、Timeline 等

这些文档提供了比配置文件注释更详细的说明、示例和最佳实践。
