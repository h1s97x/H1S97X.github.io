...
- **内容分离** (技术文章迁移到 notes/, \_posts/ 只保留生活记录)
- **目录重构** (文章按年份组织, 添加 scaffolds 模板)
- **路由优化** (使用 index_generator 生成博客首页)
...
| 类型       | 目录             | 用途           | 数量  |
| ---------- | ---------------- | -------------- | ----- |
| **Posts**  | `source/_posts/` | 生活记录、思考 | 6 篇  |
| **Notes**  | `source/notes/`  | 技术文章、攻略 | 54 篇 |
| **Coding** | `source/coding/` | 编程题解       | 0 篇  |
